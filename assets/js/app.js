...
function contactPage() {
  ...
  pageHero("Contact",
    ...
    heroMedia(300, slot("/assets/images/axisforce-contact-hero.webp", "Headset and laptop on a desk with a plant, showing call, email, and location icons", "", "", "", "contact-hero-img"))) +
  '<section style="background: #f2f5fa; color: #131a28; padding: 56px 32px 72px;">' +
